    ...
    <div x-show="tab === 'email'" x-cloak>
        ...
        <div x-show="emailMode === 'signup'" x-cloak>
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <label class="block text-sm text-gray-600">
                    Password
                    <input type="password" name="password" required minlength="8" class="mt-1 w-full rounded border border-gray-300 px-3 py-2 focus:border-accent focus:outline-none">
                </label>
                <label class="block text-sm text-gray-600">
                    Confirm password
                    <input type="password" name="password_confirmation" required class="mt-1 w-full rounded border border-gray-300 px-3 py-2 focus:border-accent focus:outline-none">
                </label>
